    ...
    >
      ...
      <header
        ...
        style={{
          ...
          padding: scrolled ? '20px 0 0' : '14px 0 0',
        }}
      >
        <nav
      ...
      <div ref={contentRef}>
        ...
        <footer className="overflow-hidden border-t border-white/[0.06] pt-14">
          ...
          <div
            className={`mt-12 flex flex-col items-start justify-between gap-6 border-t border-white/[0.06] py-8 md:flex-row md:items-center md:pr-28 ${GX}`}
          >
            <img
              src={config.meta.logo}
              alt="Ravenn Studio"
