...
export default {
  ...
  hero: {
    eyebrow: 'Landing pages de alta conversão para Google Ads',
  ...
  consequence: {
    ...
    lossCaption:
      'Seu anúncio entrega gente pronta pra agir. A página não convence, ela fecha a aba. O clique que você pagou não virou nada.',
    ...
    slides: [
      {
        ...
        body: 'Negócios que rodam Google Ads mas mandam o tráfego pra home ou pra um site genérico. Veem o custo por aquisição subir sem entender por quê.',
