...
const sections = [
  {
    ...
    body: (
      <P>
        Estes Termos de Uso regem o acesso e a utilização do site revanastudio.com.br e das landing
        pages vinculadas a ele, de propriedade da Revana Studio. Ao acessar e navegar neste site,
  ...
  {
    id: 'sobre',
    heading: 'Sobre a Revana Studio',
    body: (
      <P>
        A Revana Studio é uma agência de web design e marketing digital, com atuação em Niterói/RJ e
        ...
        Revana Studio, CNPJ 61.019.754/0001-88, com sede em Niterói, Rio de Janeiro.
      </P>
    ),
  },
  {
    ...
    body: (
      <>
        <P>
          ...
          forma de contato da Revana Studio. A simples navegação ou o envio de uma mensagem por
      ...
      <>
        ...
        <UL
          items={[
            ...
            'Tentar obter acesso não autorizado a sistemas, servidores ou dados da Revana Studio;',
  ...
  },
  {
    ...
    body: (
      <P>
        ...
        Revana Studio ou utilizado sob licença, e está protegido pela legislação brasileira de
        ...
        autorização prévia e expressa da Revana Studio.
      </P>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <P>
          ...
          informações fornecidas são verdadeiras e autoriza a Revana Studio a utilizá-las para
  ...
  },
  {
    ...
    body: (
      <P>
        ...
        sites de terceiros (incluindo projetos de clientes reais). A Revana Studio não se
  ...
  },
  {
    ...
    body: (
      <P>
        ...
        fatores externos ao controle exclusivo da Revana Studio, e são tratados de forma específica
  ...
  },
  {
    ...
    body: (
      <P>
        Na máxima extensão permitida pela legislação aplicável, a Revana Studio não se
  ...
  },
  {
    ...
    body: (
      <P>
        A Revana Studio pode atualizar estes Termos de Uso a qualquer momento, para refletir
