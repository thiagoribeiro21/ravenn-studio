...
/* `link` é opcional — quem não passar nada mantém o comportamento original
   ...
   seção via config, sem precisar duplicar este componente. */
export default function WhatsAppButton({ link = WA_LINK }) {
  return (
    <motion.a
      href={link}
      target="_blank"
      ...
      style={{
        ...
        bottom: 24,
        right: 24,
        zIndex: 9999 /* fora do SiteShell → relativo ao viewport */,
        width: 56,
        height: 56,
        borderRadius: '50%',
        background: '#25D366',
        ...
        textDecoration: 'none',
        boxShadow: '0 4px 20px rgba(37,211,102,0.40), 0 8px 32px rgba(0,0,0,0.30)',
        cursor: 'pointer',
        outline: 'none',
      }}
    >
      ...
      {/* WhatsApp SVG */}
      <svg aria-hidden width="28" height="28" viewBox="0 0 24 24" fill="white">
