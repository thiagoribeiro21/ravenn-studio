...
export default function ManifestoSection() {
  ...
  return (
    ...
    >
      ...
      {/* biome-ignore lint/a11y/noStaticElementInteractions: hover puramente decorativo (imagem flutuante), sem consequência funcional */}
      <div
        ref={listRef}
          ...
          <AnimatePresence>
            {hoverIdx !== null && (
              <motion.div
                ...
                aria-hidden
                ref={(el) => {
                  if (el) cardHRef.current = el.offsetHeight;
                }}
                ...
                style={{
                  ...
                  boxShadow:
                    '0 40px 90px -20px rgba(0,0,0,0.80), 0 0 44px -14px rgba(124,58,237,0.35)',
                }}
              >
                <img
                ...
                <div
                  ...
                  style={{
                    ...
                    inset: 0,
                    background:
                      'linear-gradient(160deg, rgba(124,58,237,0.30) 0%, rgba(0,0,0,0.55) 100%)',
