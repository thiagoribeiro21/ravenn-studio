...
const SERVICES = [
  {
    ...
    description:
      'Presença digital que impõe respeito antes da primeira reunião. Design premium, estrutura técnica de SEO Local e velocidade que colocam sua empresa no topo do Google — exatamente onde decisões de alto valor são tomadas.',
  ...
  },
  {
    ...
    description:
      'Cada real investido em tráfego pago merece uma página que converte, não que apenas existe. Copywriting orientado a vendas, design exclusivo sem templates e rastreamento pixel-perfeito — entrega em 7 dias úteis.',
  ...
  },
  {
    ...
    description:
      'Imagine um site que se comporta como um filme: cenas em 3D que reagem ao scroll, transições cinematográficas e uma navegação que parece mágica — como os efeitos visuais deste nosso próprio site. Para marcas de luxo, estúdios de arquitetura e design que não podem se dar ao luxo de parecer comuns.',
  ...
  },
  {
    ...
    description:
      'Chega de depender só do balcão. Criamos lojas virtuais de alta conversão com checkout ultrarrápido, vitrine que faz o produto vender sozinho e integração direta com os principais meios de pagamento — para faturar em vendas online enquanto você dorme.',
  ...
  },
  {
    ...
    description:
      'Colocamos sua empresa na frente do cliente certo, no exato momento em que ele digita a busca e está pronto para comprar. Gestão orientada por dados, otimização semanal e foco obsessivo em custo por aquisição real — não em vaidade de métricas.',
  ...
  },
  {
    ...
    description:
      'Enquanto sua equipe dorme, seus concorrentes atendem. Agentes de IA treinados no seu negócio respondem, qualificam e agendam pelo WhatsApp 24 horas por dia — garantindo que nenhuma venda se perca às 3 da manhã.',
      ...
      {!isDesktop && (
        <div
          style={{
            position: 'sticky',
            top: 80,
            zIndex: 5 /* top=80 respeita navbar height */,
          ...
          <div className="w-28 h-28 md:w-36 md:h-36 relative">
            <div
              ...
              style={{
                ...
                inset: 0,
                borderRadius: '50%',
                background: 'radial-gradient(circle, rgba(76,29,149,0.28) 0%, transparent 70%)',
                pointerEvents: 'none',
              }}
            />
            {canvas3D && (
              <Suspense
                fallback={
                  <div className="w-full h-full rounded-full" style={{ background: '#03000A' }} />
                }
              >
          ...
          >
            <div
              ...
              style={{
                ...
                inset: 0,
                background:
                  'radial-gradient(ellipse 70% 60% at 50% 50%, rgba(76,29,149,0.18) 0%, transparent 70%)',
                pointerEvents: 'none',
              }}
            />
            <div
            ...
            >
              {canvas3D && (
                <Suspense
                  fallback={<div className="w-full h-full" style={{ background: '#03000A' }} />}
                >
                  <ThreeServicesCanvas activeIndex={activeIdx} />
                </Suspense>
              )}
