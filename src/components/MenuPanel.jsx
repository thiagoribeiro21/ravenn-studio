...
/* Antes todos os 6 apontavam pra `#services` (a seção de serviços da PRÓPRIA
   ...
   scroll-in-page ou deixa o `<a>` navegar normalmente. Lista vem de
   `utils/services.js` — fonte única compartilhada com Footer.jsx e
   RelatedServices.jsx, pra não haver risco de divergirem de novo. */
const SUB_LINKS = SERVICES.map((s) => ({ label: s.label, href: solucaoHref(s.slug) }));
  ...
  const handleNav = useCallback(
    (e, href) => {
      ...
      setTimeout(() => {
        ...
        if (el && cnt) {
          const offset =
            el.getBoundingClientRect().top - cnt.getBoundingClientRect().top + cnt.scrollTop;
  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        transition={{ delay: isOpen ? 0.28 : 0, duration: 0.3 }}
        onClick={closeMenu}
      ...
      >
        {/* Nav links */}
        <motion.nav variants={listVariants} initial="closed" animate={isOpen ? 'open' : 'closed'}>
              ...
              {sub ? (
                ...
                <div>
                  <button
                    ...
                    aria-controls="menu-solutions-sub"
                  ...
                  >
                    ...
                    <span
                      style={{
                        color: solutionsOpen ? '#A78BFA' : 'rgba(255,255,255,0.35)',
                        marginTop: 4,
                        transition: 'color 280ms ease',
                      }}
                    >
        ...
        >
          <div
            style={{
              width: 40,
              height: 1,
              background: 'linear-gradient(to right, rgba(124,58,237,0.50), transparent)',
              marginBottom: 14,
            }}
          />
          <a
