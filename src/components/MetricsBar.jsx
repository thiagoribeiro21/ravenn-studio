...
const METRICS = [
  {
    ...
    detail: 'Sites otimizados para velocidade extrema e SEO',
  },
  {
    num: '24/7',
    label: 'Atendimento Automático',
    detail: 'Agentes de IA trabalhando para você sem pausas',
  },
  {
    num: '100%',
    label: 'Código Exclusivo',
    detail: 'Zero templates. Design construído sob medida para sua marca',
  },
];
      ...
      >
        {METRICS.map(({ num, label, detail }, i) => (
          <motion.div
            ...
            viewport={{ once: true }}
            className={
              i < METRICS.length - 1 ? 'border-b sm:border-b-0 sm:border-r border-[#1E1B4B]' : ''
            }
            style={{
              display: 'flex',
